    ...
    $(function () {
        ...
        var Login = function () {
            ...
            function postData(address, data, cb, cbErr) {
                // код для использования csrf-токена
                                ...
                                postData('/login', $this.data('send'), function (result) {
                                    if (result != null && result.result) {
                                        ...
                                        if (result) {
                                            ...
                                            $thisStep.find('.form-input:not(.form-input_hide)[type="text"]').addClass('form-input_error').after('<div class="form-error">' + 'Пользователь не найден или неверный логин или пароль' + '</div>');
                                        }
                                    }
                                })
                            }
