    ...
    $(function () {
        ...
        var Login = function () {
            ...
            function postData(address, data, cb, cbErr) {
                // код для использования csrf-токена (работа БЕЗ jwt)
                ...
                $.ajax({
                    ...
                    complete: function (result) {
                        if (result.status === 200) {
                            ...
                            alert(`Ошибка ${result.status} ${result.responseJSON.result}`);
                            if (cbErr) {
            ...
            return {
                init: function () {
                    ...
                    $('#submitPhone').on('click', function () {
                        ...
                        postData('/registerContactConfirmation', data, function (result) {
                            if (result.result) {
                    ...
                    $sendButton.on('click', function (e) {
                        ...
                        if ($this.is('[data-send]')) {
                            ...
                            if (!error) {
                                postData('/loginContactConfirmation', $this.data('send'), function (result) {
                                    if (result.result) {
                            ...
                            if (!error) {
                                postData('/login', $this.data('send'), function (result) {
                                    if (result != null && result.result) {
                                        ...
                                        //     .after('<div class="form-error">' + 'Пользователь не найден или неверный логин или пароль' + '</div>');
                                        // }
                                    }
                                })
                            }
                    ...
                    $ProductAssesment.find('.Rating input').on('change', function (e) {
                        ...
                        Login().postData('/books/rateBook', {
                            ...
                            if (result.result === 'true') {
                                ...
                                $title.addClass('Rating-title_success').text('Оценка пользователя не изменилась');
                            } else {
